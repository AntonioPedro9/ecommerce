    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <div className="flex justify-between">
          ...
          <p className="text-muted-foreground text-sm font-medium">{formatCentsToBRL(subtotalInCents)}</p>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <p className="text-muted-foreground text-sm font-medium">{formatCentsToBRL(totalInCents)}</p>
        </div>
